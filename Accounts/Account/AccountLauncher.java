...
public class AccountLauncher {
    ...
    */
     ...
     * and returns it if it is an instance of CreditAccount. Otherwise, it prints an error message
     * indicating no logged-in credit account is found, and returns null.
     *
